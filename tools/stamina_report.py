...
KNOWN_SITES = [
    ...
    ("utils.js", 168, 177, "天气·户外消耗"),
    ("utils.js", 199, 214, "冲刺甩追兵"),
    ("utils.js", 355, 374, "战斗·近战胜利"),
    ("utils.js", 444, 456, "躲藏失败"),
    ("core.js",  418, 431, "饥饿·规则"),
    ("core.js",  440, 456, "连续移动疲劳·规则"),
    ("core.js", 1180, 1200, "喝水(+1)"),
    ("core.js", 1220, 1232, "吃冻肉(回满)"),
    ("core.js", 1320, 1335, "吃维C(+1)"),
...
def selftest():
    ...
    gm += 50; push(gm, "core.js:449", -2, 3.5, travel=40, weather="雨")
    ...
    push(23 * 60 + 50, "story/core.js:1224", 5.5, 10)                 # 吃冻肉回满
    ...
    need("连续移动疲劳·规则" in text, "core.js:449 归因为疲劳")
