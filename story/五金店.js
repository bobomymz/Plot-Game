...
Object.assign(storyData, {
  ...
  // ==================== 五金店入口（三林路） ====================
  "五金店": {
    image: "images/小区周边/hardwareStore.png",
    onEnter: { set: { currentPlace: "三林路", currentPos: "五金店" } },
    text: "你来到三林路上那家老五金店。卷帘门半开着，里面黑漆漆的，看不清有什么。一股机油和铁锈的气味从门缝里飘出来。\n你注意到侧面的窗户破了一扇，后巷也能绕过去。",
    choices: [
      {
        text: "从正门钻进去",
        nextScene: "五金店-正门"
  ...
  "五金店-正门-照明": {
    image: "images/小区周边/hardwareStoreInside.png",
  ...
  "五金店-前台": {
    image: "images/小区周边/hardwareStoreCounter.png",
    text: "你绕过柜台。后面的架子上确实放着一些瓶瓶罐罐——油漆、松节油、润滑剂……但你还没来得及看清具体的标签，就闻到了一股不寻常的气味。\n不是机油，不是油漆。是一种甜腻的、让人头晕的气味。你低头——柜台下方有一根管道裂了，正冒出淡淡的白色气体。\n你已经吸进去了。你的视野开始模糊，腿发软。你想后退，但身体不听使唤。你摔倒在地上，离那扇紧闭的卷帘门只有几步之遥，但你连抬手的力气都没有了。",
    choices: [
      {
        text: "试图向门口爬去",
        nextScene: "结局-五金店-毒气"
  ...
  // ==================== 侧窗路线 ====================
  "五金店-侧窗": {
    image: "images/小区周边/hardwareStoreSide.png",
  ...
  "五金店-侧窗-探索": {
    image: "images/小区周边/hardwareStoreTools.png",
  ...
  // ==================== 后巷路线 ====================
  "五金店-后巷": {
    image: "images/小区周边/hardwareStoreBack.png",
...
锁环没有断——你的铁管倒是先断了。而且刚才那声巨响……肯定引起了什么东西的注意。现在这扇铁栅栏门也没撬开，地下室的位置也暴露了，真是两头不讨好。";
  ...
  "五金店-暗道-地铁隧道": {
    image: "images/metro/trainTunnel.png",
...
前方出现了亮光——不是日光，是一种昏黄的灯光。你走过去，发现通道尽头是一个检修口，通向一条宽阔的隧道。轨道。\n是地铁隧道。\n你刚刚意识到这一点时，隧道深处传来一阵越来越响的轰鸣声。地面开始震动。一束刺眼的灯光从黑暗的隧道深处直射而来。\n你转身想跑——但来不及了。",
  ...
  "结局-五金店-地铁": {
    image: "images/小区周边/tunnelCrash.png",
    text: "列车以不可阻挡的速度碾过。在最后的一瞬间，你想到的是——这条线路居然还在运行？\n\n—— 结局：五金店地铁 ——"
  },

  "五金店-暗道-仓库": {
    image: "images/小区周边/hardwareStoreStorage.png",
