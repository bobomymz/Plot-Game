...
Object.assign(storyData, {
  ...
  // ==================== 入口 ====================
  "图书馆": {
    image: "images/library/libraryFront.png",
  ...
  "图书馆-侧窗": {
    image: "images/library/librarySide.png",
...
它还没注意到你。",
  ...
  "图书馆-大厅-声东击西": {
    image: "images/library/libraryBookThrow.png",
  ...
  // ==================== 阅览室 ====================
  "图书馆-阅览室": {
    image: "images/library/libraryReadingRoom.png",
...
靠窗的座位上坐着一个人——一只穿着格子衬衫的丧尸。它低着头，双手捧着一本摊开的书，像在阅读一样。\n你没出声，但它似乎感觉到了什么，翻页的动作停了一下。",
  ...
  "图书馆-阅览室-惊醒": {
    image: "images/library/libraryZombieStandUp.png",
  ...
  "图书馆-阅览室-书架倒": {
    image: "images/library/libraryFallingShelf.png",
    onEnter: { add: { strength: -1 } },
  ...
  // ==================== 藏书区入口 ====================
  "图书馆-藏书区入口": {
    image: "images/library/libraryBookshelf.png",
...
你冲到通道尽头，拐过弯，看到了一扇贴着\"办公区\"牌子的门。你拉开门钻了进去，反手关上。\n外面传来脚步声由远及近，然后在门外停了下来。几秒后，脚步声又渐渐远去了。",
  ...
  // ==================== 办公室（最终战） ====================
  "图书馆-办公室": {
    image: "images/library/libraryOffice.png",
...
就是这一下犹豫——它猛地抽出了一只手，抓伤了你的脚踝。\n你踉跄了一下，但站稳了脚步，一脚踢开了它的手。脚上传来的刺痛告诉你，没法安心在这里待下去了。",
  ...
  // ==================== 逃生 ====================
  "图书馆-逃生": {
    image: "images/library/libraryFireExit.png",
