...
Object.assign(storyData, {
  ...
  "三林安居苑-驱赶变异猫": {
    image: "images/anJuYuan/mutantCat.png",
...
对峙了几秒后，带头的那只大猫转身跑进了花坛深处，其他的也跟着散了。\n小区暂时安全了，至少入口是。",
  ...
  "三林安居苑-小区内部": {
    ...
    text: function(vars) {
      ...
      basicDes += "小区南侧有一扇通往安盛街的后门。\n一楼的几户人家门窗紧闭，有一家的门虚掩着，门口还停着一辆老式自行车，车筐里塞着半袋没来得及拿上楼的菜。"
    ...
    choices: [
      ...
      sprintAway(["三林安居苑-居民楼", "安盛街中段", "安居苑前门"])
    ]
  },
  ...
  "三林安居苑-小广场": {
    image: "images/anJuYuan/smallSquare.png",
...
再往后，就是老年人走的鹅卵石路，小时候的你一直不明白，那种路怎么会有人走得下去。",
  ...
  "三林安居苑-滑板车": {
    image: "images/anJuYuan/skboard.png",
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】拾取记忆[滑板车的盲从]</span>",
  ...
  "三林安居苑-鹅卵石路": {
    image: "images/anJuYuan/goldenE.png",
...
你骑上去试了试。很可惜，这个自行车上锁了。车篮里有一把钥匙，但不是车锁的钥匙，上面写着\"402\"。"
  ...
  // ========== 藤蔓丧尸（美工刀 + 地图） ==========
  "三林安居苑-藤蔓丧尸": {
    image: "images/anJuYuan/vineZombie.png",
    text: function(vars) {
...
藤蔓从长椅下方的花坛里疯长出来，把它整个下半身缠得严严实实。它只能扭动上半身，朝你张着黑洞洞的嘴，发出嗬嗬的气声。";
  ...
  "三林安居苑-割藤蔓": {
    image: "images/anJuYuan/cutVines.png",
  ...
  "三林安居苑-藤蔓丧尸-战斗": {
    image: "images/anJuYuan/vineZombieFight.png",
  ...
  "三林安居苑-藤蔓丧尸-击杀": {
    image: "images/anJuYuan/vineZombieDead.png",
  ...
  "三林安居苑-藤蔓丧尸-被咬": {
    image: "images/anJuYuan/vineZombieBite.png",
...
它的腿似乎断了，无法站立，但双手依然有力。听到脚步声，它转头看向你，呲着牙发出威胁的低吼。\n卧室的门关着——不知道里面有什么。",
  ...
  "三林安居苑-楼道": {
    image: "images/anJuYuan/anJuYuanStairs.png",
    onEnter: updateTime(2),
  ...
  "三林安居苑-5楼": {
    image: "images/anJuYuan/anJuYuan5F.png",
    onEnter: { set: { currentPos: "居民楼" } },
  ...
  "三林安居苑-502": {
    image: "images/anJuYuan/anJuYuan502.png",
    onEnter: { set: { currentPos: "502室" } },
    text: "钥匙在锁孔里转动了一圈，咔嗒一声，门开了。\n一股陈旧的空气扑面而来，夹杂着木头和灰尘的味道。这间屋子已经很久没人住过了。玄关的鞋架上还摆着几双拖鞋，整整齐齐，仿佛主人只是出了趟远门。地板积了一层薄灰，但墙角隐约可见几个小小的爪印——大概是老鼠留下的。\n客厅的窗帘紧紧拉着，只有一道细缝透进外面昏黄的光线。家具上盖着白布，在昏暗的光线里像几座沉默的雕塑。",
    choices: [
      {
        text: "去厨房",
  ...
  "三林安居苑-502-厨房": {
    image: "images/anJuYuan/anJuYuan502Kitchen.png",
    text: "厨房不大，但收拾得很整齐。灶台上盖着一层塑料布，掀开一看，下面的煤气灶还是老式双头灶，打火旋钮已经有些松了。\n橱柜里基本空了，只剩几包过期的盐、一瓶结了块的酱油，还有半袋早已硬成石头的白砂糖。冰箱的门虚掩着，里面黑漆漆的，飘出一股酸腐的味道——你赶紧把门关上了。\n水槽上方的窗户正对着小区花园。透过玻璃，你能看到那几只变异猫还在花坛边踱来踱去，眼睛里泛着幽幽的绿光。",
    choices: [
      {
        text: "回到走廊",
        nextScene: "三林安居苑-502"
  ...
  "三林安居苑-502-客厅": {
    image: "images/anJuYuan/anJuYuan502Livingroom.png",
  ...
  "三林安居苑-502-阳台": {
    image: "images/anJuYuan/anJuYuan502Balcony.png",
  ...
  "三林安居苑-502-小卧室": {
    image: "images/anJuYuan/anJuYuan502SmallBedroom.png",
    onEnter: function(vars) {
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】获得记忆[忘记搬家的松鼠]——有些东西你以为永远丢了，其实它一直在原地等你。</span>";
  ...
  "三林安居苑-卧室": {
    image: "images/anJuYuan/anJuYuanBedroom.png",
...
"三林安居苑-厨房": {
    image: "images/anJuYuan/anJuYuanKitchen.png",
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】你回复1点体力，当前体力：{strength}。</span>",
  ...
  "三林安居苑-厨房危险": {
    image: "images/anJuYuan/anJuYuanKitchenDanger.png",
...
——日期是两周前，看来外表寒碜。",
  ...
  "三林安居苑-喜提新车": {
    image: "images/anJuYuan/gainNewBike.png",
...
链条锈得太厉害了，没有润滑油根本没法正常骑行。也许在什么地方能找到防锈液……你记得三林路那边好像有家五金店。",
  ...
  "安居苑前门": {
    image: "images/anJuYuan/anjuyuanFrontDoor.png",
    text: "你来到了安居苑的前门",
    choices: [
      {
        text: "离开这里",
