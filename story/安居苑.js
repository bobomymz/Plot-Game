...
Object.assign(storyData, {
  ...
  // ==================== 三林安居苑（老小区） ====================
  "三林安居苑": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan.png */,
  ...
  "三林安居苑-驱赶变异猫": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/mutantCat.png */,
...
对峙了几秒后，带头的那只大猫转身跑进了花坛深处，其他的也跟着散了。\n小区暂时安全了，至少入口是。",
  ...
  "三林安居苑-小区内部": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanInside.png */,
    onEnter: { set: { currentPlace: "安居苑", currentPos: "安居苑" } },
    text: function(vars) {
...
你看向西边那栋楼，一楼的几户人家门窗紧闭，有一家的门虚掩着，门口还停着一辆老式自行车，车筐里塞着半袋没来得及拿上楼的菜。\n\
东边那栋的门牌上写着\"8号楼\"——二楼靠东的窗户开着一道缝，像是被人推开后就没关回去。窗台上搁着一只白色的搪瓷缸，上面印着褪了色的红字。风大的时候，能听到什么东西在啪嗒啪嗒地响。"
  ...
  "三林安居苑-小广场": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/smallSquare.png */,
...
再往后，就是老年人走的鹅卵石路，小时候的你一直不明白，那种路怎么会有人走得下去。",
  ...
  "三林安居苑-滑板车": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/skboard.png */,
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】拾取记忆[滑板车的盲从]</span>",
  ...
  "三林安居苑-鹅卵石路": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/goldenE.png */,
...
你骑上去试了试。很可惜，这个自行车上锁了。车篮里有一把钥匙，但不是车锁的钥匙，上面写着\"402\"。"
  ...
  // ========== 藤蔓丧尸（美工刀 + 地图） ==========
  "三林安居苑-藤蔓丧尸": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/vineZombie.png */,
    text: function(vars) {
...
藤蔓从长椅下方的花坛里疯长出来，把它整个下半身缠得严严实实。它只能扭动上半身，朝你张着黑洞洞的嘴，发出嗬嗬的气声。";
  ...
  "三林安居苑-割藤蔓": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/cutVines.png */,
  ...
  "三林安居苑-藤蔓丧尸-战斗": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/vineZombieFight.png */,
  ...
  "三林安居苑-藤蔓丧尸-击杀": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/vineZombieDead.png */,
  ...
  "三林安居苑-藤蔓丧尸-被咬": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/vineZombieBite.png */,
  ...
  "三林安居苑-居民楼": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanBuilding.png */,
    onEnter: { set: { currentPos: "居民楼" } },
    text: "你走进居民楼的入口。楼道里很暗，只有安全出口指示牌发出微弱的绿光。墙上一排信箱锈迹斑斑，好几格的盖子都掉了下来，里面塞着积了灰的广告传单和催缴单。\n\
...
左手边是锈蚀的信箱，其中一格上贴着住户标签：203、204。走廊尽头的楼梯拐角处散落着几张报纸，日期停在了6月27日。",
  ...
  "三林安居苑-8号楼-2楼": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan5F.png */,
...
204的门虚掩着，门缝里飘出一股淡淡的甜腻味——说不清是什么，但让你本能地不想多闻。",
  ...
  "三林安居苑-203室": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan502.png */,
...
你上次没拿的东西还在原处：窗台上的搪瓷缸、桌子上的旧防毒面具和笔记本，地上的空水瓶。";
  ...
  "三林安居苑-204室-老洪": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanKitchen.png */,
...
他是想把自己锁住。在失去意识之前，他做了最后一件事——绑好自己。",
  ...
  "三林安居苑-楼道": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanStairs.png */,
    onEnter: updateTime(2),
  ...
  "三林安居苑-502-厨房": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan502Kitchen.png */,
  ...
  "三林安居苑-502-客厅": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan502Livingroom.png */,
  ...
  "三林安居苑-502-阳台": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan502Balcony.png */,
  ...
  "三林安居苑-502-小卧室": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan502SmallBedroom.png */,
    onEnter: function(vars) {
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】获得记忆[忘记搬家的松鼠]——有些东西你以为永远丢了，其实它一直在原地等你。</span>";
  ...
  "三林安居苑-卧室": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanBedroom.png */,
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】你回复1点体力，当前体力：{strength}。</span>",
  ...
  "三林安居苑-厨房危险": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanKitchenDanger.png */,
  ...
  "三林安居苑-自行车": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/rustyBike.png */,
...
——日期是两周前，看来外表寒碜。",
  ...
  "三林安居苑-喜提新车": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/gainNewBike.png */,
...
链条锈得太厉害了，没有润滑油根本没法正常骑行。也许在什么地方能找到防锈液……你记得三林路那边好像有家五金店。",
  ...
  "安居苑前门": {
    image: "images/placeholder.png" /* TODO: images/anJuYuan/anjuyuanFrontDoor.png */,
    text: "你来到了安居苑的前门",
    choices: [
      {
        text: "离开这里",
  ...
  "三林安居苑-躲藏": hideOnLocation("images/placeholder.png" /* TODO: images/anJuYuan/anJuYuan.png */,
  ...
  "三林安居苑-小区内部-躲藏": hideOnLocation("images/placeholder.png" /* TODO: images/anJuYuan/anJuYuanInside.png */,
