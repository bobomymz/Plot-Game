...
Object.assign(storyData, {
  ...
  // ==================== 入口：地面 → 站厅 ====================
  "11号线-三林东路站": {
    image: "images/metro/stationEntrance.png",
    onEnter: { set: { currentPlace: "东明路", currentPos: "地铁站" } },
    text: "你走进11号线三林东路站的入口。台阶向下延伸，通向一片昏暗的站厅。应急灯亮着，投下惨白的冷光。\n闸机全部敞开着——这不是正常关闭的，有些是被暴力撞开的。地上有干涸的血迹和散落的杂物。\n站厅里很安静，但你隐约能听到站台方向传来的回音——什么东西在移动。",
    choices: [
      {
        text: "快步通过闸机，进入站厅",
        nextScene: "地铁站-站厅层",
  ...
  "地铁站-站厅层-观察": {
    image: "images/metro/stationHall.png",
  ...
  // ==================== 安检区（QTE: 6s，隐藏） ====================
  "地铁站-安检区": {
    image: "images/metro/securityCheck.png",
    onEnter: { set: { currentPlace: "东明路", currentPos: "地铁站" } },
    qte: {
  ...
  // ===== 消防栓路线（你的正解链第一步） =====
  "地铁站-安检区-消防栓": {
    image: "images/metro/fireHose.png",
  ...
  "地铁站-安检区-消防斧清场": {
    image: "images/metro/axeSlaughter.png",
  ...
  "地铁站-安检区-灭火器雾障": {
    image: "images/metro/fireExtinguisherFog.png",
  ...
  // ==================== 楼梯（QTE: 4s，可见） ====================
  "地铁站-楼梯": {
    image: "images/metro/stairs.png",
    qte: {
      timeout: "4000 - chasedByZombies * 400",
      onTimeout: "地铁站-楼梯-犹豫"
    },
    text: "你来到楼梯口。台阶向下延伸，转角处堆着一些被遗弃的行李箱和几只倒下的垃圾桶。楼梯上零星有几只丧尸——它们正在漫无目的地徘徊，还没注意到你。\n而在你身后，被你用水冲散的丧尸群已经开始爬起来了。你听到水花四溅的声音——它们追上来了。",
    choices: [
      {
        text: "冲下去，踹飞挡路的那只！",
        nextScene: "地铁站-楼梯-踹飞",
  ...
  // ==================== 站台层（QTE: 3s，可见） ====================
  "地铁站-站台层": {
    image: "images/metro/platform.png",
    onEnter: { set: { currentPlace: "东明路", currentPos: "地铁站" } },
    qte: {
  ...
  "地铁站-站台层-灭火器雾障": {
    image: "images/metro/platformFog.png",
    onEnter: { set: { _extinguisherUsed: true } },
...
你在一排排屏蔽门之间狂奔，身后拖着一串越来越长的脚步声和嘶吼声。列车门就在前方——你冲进去的时候，最近的一只丧尸离你只有几步之遥。\n你转过身，面对着正在涌来的丧尸群，站在车厢里大口喘气。",
  ...
  // ==================== 选择列车 ====================
  "地铁站-选择列车": {
    image: "images/metro/trainInterior.png",
  ...
  "地铁站-线路图": {
    image: "images/metro/trainMap.png",
  ...
  // ==================== 出发！ ====================
  "地铁站-迪士尼方向": {
    image: "images/metro/trainDeparting.png",
