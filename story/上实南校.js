...
“教学楼西侧有个小侧门，常年锁着，密码锁的密码就是这个——总务处每年开学才换一次，我偶然看到的。”她苦笑了一下，“侧门出去就是华夏西路的支路，比正门好走。你要是以后再来学校，走那边安全些。”\n\
...
\"教学楼西侧小侧门的密码。\"她压低声音，\"侧门出去就是华夏西路的支路，比正门好走。你以后来的话，走那边安全些。\"\n\
她看了一眼角落里的孩子们：\"我暂时不能跟你走。这些孩子……我放不下。\"",
  ...
  "上实南校-图书馆-承诺": {
    ...
    text: function(vars) {
      ...
      return "王老师看着你，沉默了几秒。然后她笑了一下——那个笑容里有一半是感激，一半是\"我教了这么多年的书，今天被我的学生救了\"的复杂。\n\
\"你自己也小心。\"她说，\"我这儿你不用太担心——撑几天还是可以的。你要是有什么事需要帮忙……我虽然干不了架，但写东西、记东西、认路，还行。\"";
    },
    choices: [
      {
        text: "离开图书馆",
