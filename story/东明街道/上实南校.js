...
前方通往2号楼的门是一扇生锈的铁栅栏门，门轴锈死了，推不动。",
  ...
  "上实南校-2号楼走廊": {
    ...
    text: function(vars) {
      ...
      return [
        "你走进2号楼走廊。这里比1号楼暗一些，日光灯管大部分不亮了。走廊两侧是教室，门牌写着“初一（3）班”、“初一（4）班”……。",
        "你正准备往前走，突然听到前方拐角处传来沉重的拖拽声——呲啦、呲啦——金属在地面上拖。",
...
————结局：你这防毒面具保熟吗————";
  ...
  "上实南校-图书馆": {
    ...
    text: function(vars) {
      ...
      return [
        "你推开图书馆的门——准确地说，是推开了一道缝，另外半边门被书架从里面堵死了。你侧身挤了进去。",
...
她顿了顿，声音更低了：“真是糟透了。连饮水机都没有。”\n\
但她很快深吸一口气，直了直腰——那个在讲台上站了十几年的语文老师的惯性，让她即使在末日里也会在学生面前挺直背。\n\
“你呢？你一个人？你的家人……还在吗？外面现在到底怎么样了？”\n\
她转头看着窗外的操场，喃喃自语，“这里没什么吃的了……你不能在这里久留的。”",
    choices: [
      {
...
“学长？“耳边传来一个女同学的声音，你回头一看，认出她是以前在公交车上见过几次的朵拉头学妹，虽然你并不知道她叫什么。\n\
”你好呀。“”竟然能在这里碰到你。“\n\
王老师回头看了看，说道：”保重。“",
    choices: [
      {
...
那张脸曾经是王老师——银框眼镜，乱糟糟的马尾。现在眼镜歪了，马尾散了一半，皮肤灰青。歪掉的镜片后面，两只眼睛对不上焦。\n她张了张嘴，喉咙里挤出一声含混的嘶吼。\n\
...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】获得记忆[返校]",
    choices: [
      // 高锦睿线索（一次性）：给"为什么他不会在原地等你"的行为逻辑，不泄露具体时间窗
      {
        text: "“你们还见过别的同学吗？”",
        nextScene: "上实南校-撤离成功-高锦睿",
        showCondition: "(_visit['物业楼'] > 0 || _metGaoAtMall) && !_visit['上实南校-撤离成功-高锦睿']"
      },
      {
        text: "一起回东明路",
        nextScene: "东明路-三林路"
  ...
  "上实南校-撤离成功-高锦睿": {
    ...
    text: "“别的同学？没有。但几个小时前我的破手机收到了高锦睿的消息，他说自己在东明社区食堂。”小赵看了眼手机。\n\
“那是什么地方？没去过。”小陆问。“一个老年人吃饭的公共食堂————虽然年轻人也会去。他那里竟然有网，真是稀奇。”\n\
小王问：“就在十字路口旁边吧？那里丧尸估计很多，也太危险了。”\n\
小赵点了点头：“他估计早跑了。你要找他，往那种大商场去准没错。不过他是骑车的，你是两条腿，不见得能碰上他。”",
    choices: [
      {
        text: "“知道了，你们也小心。”",
        nextScene: "东明路-三林路"
