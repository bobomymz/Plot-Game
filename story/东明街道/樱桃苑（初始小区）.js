...
闹钟显示7:30，如果是在往日，早读已经过去一半了。\n哦，这么算的话，再过半小时，妈妈就买早餐回来了。<span style='font-size: 12px;'>鼠标点击此框可以快速过剧情哦，若再点一次可以展开</span>\n<span style='font-size: 12px;'>带 🔍 标记的场景图可以点开细看。</span>";
      ...
      if (vars.dd == 1 && vars.hh >= 11) return "有点饿了，妈妈为什么还没回来呢？";
      return "";
    }, 
...
……\n\
哦对了，你住的是20号楼。你有2个初中同学分别住在24号和31号楼，他们还好吗？",
    choices: [
      {
        text: "继续",
        nextScene: "1楼-安全"
...
突然，一只丧尸从一根柱子后面闪了出来，你无法继续前进。",
  ...
  "地下车库的丧尸": {
    ...
    onEnter: {shake: true},
    text: function(vars) {
      if(vars._visit['地下车库的丧尸'] == 1) return "丧尸向你袭来，你要攻击它哪里？";
      return "又是一只丧尸向你袭来，你要攻击它哪里？";
    },
    qte: {
...
你向右旋转圆形把手，防爆门锁死，成功地用防爆门把将丧尸夹扁。\n<span style='color: #ffaa00; font-style: italic;'>【系统提示】体力-1，当前体力：{strength}。</span>",
  ...
  "墙上的痕迹": {
    ...
    text: "墙上贴满了广告：公积金贷款、下水道维修、黄色小卡片，中间还有张寻人启事，失踪者叫“林奇”。撕得零零碎碎的，倒像谁的收藏品展览。",
    choices: [
      {
        text: "继续",
        nextScene: "B1-2nd"
...
—— 结局：浓郁的香味 ——"
  ...
  "物资区的丧尸": {
    ...
    choices: [
      ...
      {
        text: "还愣着干啥快跑啊",
        condition: "Math.random() < 0.5", // 有一半概率踩塌楼梯
        nextScene: "民防设施-等候区",
        effect: updateTime(1), // 花1分钟原路返回
        elseScene: "结局-民防设施楼梯断裂"
      }
    ]
  },
...
【五、检修总体结论】\n\
☑ 基本合格，存在轻微问题，限期整改\n\
总体问题汇总：丙区-7号储藏室东北角墙体渗潮及防鼠网破损已修复。安全出口门锁已做临时处理，建议下次检修更换。楼梯木质地板已超过使用年限3年。其余物资储备正常，账物相符。\n\n\
【六、整改落实情况】\n\
整改责任人：王\n\
整改完成时限：2024年09月26日\n\
整改措施：东北角渗潮处已做防水封堵处理，防鼠网已更换，待观察后复查。楼梯问题已上报物业处，待处理。\n\
整改复核结果：合格　复核人签字：刘\n\n\
检修人员签字：王（2024.09.12）\n\
...
死寂。";
  ...
  "樱桃苑-4楼": {
    ...
    text: "四楼的走廊比楼下更暗——声控灯坏了两盏，只剩远处一盏在忽明忽暗地挣扎。空气里弥漫着一股浓重的铁腥味，混着撕开的腹腔里淌出来的酸腐。\n走廊中段，三个身影正背对着你，弓着腰围在一扇门前，发出低沉的咀嚼声。\n\
...
墙上有人用记号笔歪歪扭扭写了一行字：\n<em>高某到此一游。下一站，新达汇。</em>";
      ...
      if (!vars.hasCommitteeKey && !(vars._visit['物业楼-居委会办公室'] > 0)) {
        desc += "\n走廊尽头那扇办公室的门关得严实，锁孔里没插钥匙，你一推，门板原样顶回来。";
      }
      return desc;
    },
    choices: [
  ...
  "物业楼-居委会-门锁了": {
    ...
    text: "你握住门把手用力往下按——锁芯卡住，把手压到底也白费。那扇门上了锁，得找钥匙才打得开。",
    choices: [
  ...
  "物业楼-居委会办公室": {
    ...
    onEnter: { set: { positionAfterOperation: "物业楼-居委会办公室" } },
...
“等我把车修好就走——”他把扎带剪断，捏了捏变速器，链条咔嗒一声归位了。“<em>我去找我女朋友。</em>”\n最后这句声音突然低了下去，像是在说给自己听。\n";
      // 与物业楼墙上那句"下一站，新达汇"对账：当面也得说出去哪儿，否则玩家只知道他"走了"，不知道去哪找
      desc += "“去哪儿找？”你问。\n\
“新达汇。”他终于抬了下头，朝窗外扬了扬下巴，“那一片开阔，有东西过来我老远就能看见，骑车跑得掉。再说商场里总有吃的。”\n\
他捏着变速器的手紧了一下：“她家就住在那一带。”\n";
