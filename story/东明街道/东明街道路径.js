...
<span style='color: #00fbffff; font-style: italic;'>【系统提示】不要长时间在户外走动，天气很热，体力会大量消耗，请玩家及时寻找补给品。</span>\n"
 + describeWeather(vars) + "\n" + describeZombieWave(vars);
  ...
  "前往金谊广场-1": travelScene(
    "你转身向西，沿着三林路朝金谊广场的方向走。身后十字路口那些丧尸的嚎叫渐渐远了，但路两侧歪斜的车辆和破碎的店面让你不敢掉以轻心。\n你尽量沿着右侧没丧尸的地方走，脚步放得很轻。",
    "前往金谊广场-2",
...
直到，金谊广场的地界出现在眼前——沿街商铺的尽头是地面停车场的入口，河对岸，一个“龙头”远远地探出檐角。",
    "金谊广场-停车场入口",
    { onEnter: { set: { showRain: true } } }
  ),
  ...
  "银行内部": {
    ...
    text: function(vars) {
      if (["银行-保安室", "银行-保安室-歇脚", "银行-拿水", "银行-金库", "银行-存款凭条", "整理整理"].indexOf(vars._lastScene) >= 0) {
        return "你回到银行大厅。叫号机倒在地上，宣传单页撒了一地，几盆绿植被打翻，泥土和碎瓷片混合在一起。\n\
ATM机被砸开了，屏幕碎裂，里面空空如也。\n\
保安室的门半开着，里面黑洞洞的，似乎有什么东西在动……好像是错觉。";
      }
      return "你推开银行的玻璃门。大厅里一片狼藉——叫号机倒在地上，宣传单页撒了一地，几盆绿植被打翻，泥土和碎瓷片混合在一起。\n\
  ...
  "联华超市": {
    ...
    text: function(vars) {
      if (["小超市-香肠", "联华超市-吃香肠", "联华超市-补给", "联华超市-歇脚", "联华超市-仓库"].indexOf(vars._lastScene) >= 0) {
        return "货架上的东西还是老样子——几瓶矿泉水、几袋饼干散落在货架上。\n\
几排货架后面有什么，你也不清楚。";
      }
      return "你走进联华超市。货架上东西不多，但比起那些被扫荡一空的店铺，这里还算有些存货——几包方便面、几瓶矿泉水、几袋饼干散落在货架上。\n\
...
货架上还有几根香肠，你要吃吗？",
  ...
  "联华超市-仓库": {
    ...
    text: function(vars) {
      var desc = vars._lastScene === "联华超市-仓库-遇见周师傅"
        ? "周师傅还蹲在纸箱堆里翻找，你从他身边绕过去，继续查看仓库。仓库里堆着几箱饮料和一些滞销的零食。角落里有一扇活板门。"
        : "你来到了超市仓库。仓库里堆着几箱饮料和一些滞销的零食。角落里有一扇活板门。";
  ...
  "东明路-三林路-躲藏": hideOnLocation("images/躲藏.webp",
    "你蹲在一棵粗大的法国梧桐后面，但尸群太密集了——它们从树干两侧漫过去，树干根本挡不住你。你只能提前暴露，在丧尸反应过来之前冲出去。慌乱中你被一根树枝绊了一下，擦伤了手臂。",
