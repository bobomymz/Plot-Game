...
左手边是锈蚀的信箱，其中一格上的住户标签已经缺失，看起来是204室。走廊尽头的楼梯拐角处散落着几张报纸，日期停在了6月27日。",
  ...
  "三林安居苑-8号楼-2楼": {
    ...
    text: "你走上二楼。走廊里很安静，只有风一下一下地拍打着窗框。\n\
两扇门在眼前：203和204。\n\
...
它的腿似乎断了，无法站立，但双手依然有力。听到脚步声，它转头看向你，呲着牙发出威胁的低吼。\n卧室的门关着——不知道里面有什么。";
  ...
  "三林安居苑-7号楼-2楼": {
    ...
    text: "你扶着锈迹斑斑的扶手走上二楼。楼梯拐角靠着一辆儿童自行车，车筐里塞着几个空的饮料瓶。窗台上那盆绿萝已经有些蔫了，叶片发卷，无精打采地垂着——看来这户人家走得匆忙，没人顾得上浇水。\n\
其中一户的门上贴着一张褪色的老照片——一家三口站在迪士尼城堡前，笑得没心没肺。",
  ...
  "三林安居苑-7号楼-3楼": {
    image: "images/placeholder.png",
    onEnter: updateTime(1),
    text: "你走上三楼。一股馊掉的食物味从某扇门的门缝里飘出来，混杂着淡淡的腐臭——像是谁家的厨房在慌乱中来不及收拾，两天过去，已经彻底馊了。\n\
另一扇门虚掩着，门缝里一片漆黑。你听不见里面有声音，但也不想凑近去确认。",
  ...
  "三林安居苑-7号楼-4楼": {
    image: "images/placeholder.png",
    onEnter: updateTime(1),
    text: "你走上四楼。走廊尽头的一扇门被从里面用桌椅和纸箱堵得死死的，门缝上还缠着几圈铁丝——有人在这里躲过，而且躲得很急，像是爆发当天就把自己锁了进去。\n\
你在门口站了一会儿。里面没有任何动静。",
    choices: [
