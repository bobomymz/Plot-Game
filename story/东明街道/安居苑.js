...
藤蔓从长椅下方的花坛里疯长出来，把它整个下半身缠得严严实实。它只能扭动上半身，朝你张着黑洞洞的嘴，发出嗬嗬的气声。";
  ...
  "三林安居苑-割藤蔓": {
    ...
    text: [
      "你掏出美工刀，推出刀片，小心地靠近丧尸。它朝着你嗬嗬叫着，但够不到你——藤蔓把它的手臂也缠住了一部分。",
...
这是一间普通的一室户。客厅不大，但收拾得很干净。书桌上摊着几本翻开的专业书，页边夹着彩色便签，一台笔记本电脑合着，电源指示灯早就暗了。\n\
地上有一个敞开的双肩包，旁边散落着几根便携采样管和一支记号笔，拉链没拉上。\n\
...
工作证下面压着一张纸，折痕很深，刚从口袋里掏出来摊上桌：\n\
——仁济医院南院 检验科临时访客登记——\n\
姓名：王知筠　科室：检验科　日期：6月28日 18:30 事由：调用设备测脑脊液样本。\n\
旁边还有一张草稿纸，字迹潦草。",
    choices: [
      {
        text: "放下工作证",
...
这张卡，能刷开仁济检验科的门。你打算去看看——也许这个叫王知筠的人还留在那里，也许留下了什么。";
        ...
        return "你把门禁卡收进口袋。仁济医院检验科的卡。这张卡，该不会是小王的吧？";
      } else {
        return "你把门禁卡收进口袋。一张仁济医院检验科的门禁卡。";
      }
    },
    choices: [
      {
...
你找了一圈，确实翻到了一个，插上去一看————好家伙，竟然是坏的，没戏了。";
      }
      return desc;
    },
    choices: function(vars) {
...
他的右腿上缠着一根断掉的电线，另一端连在暖气片上——暖气片的金属表面有几道深深的划痕，电线在上面勒过。\n\
...
厨房的窗台上，放着你在楼下看到的那只搪瓷缸——白色的，缸身印着褪了色的红字，勉强能认出是“芜湖”和“先进”几个字。缸底残留着一圈干透的茶渍。";
        ...
        return "204室里那股闷腐味还在，但比上次淡了一些。他还靠在橱柜边——已经不会再动了。\n\
...
空瓶子本身也有用——如果能找到饮水机，就能打满它。",
    choices: [
      {
        ...
        condition: "itemCount < bagVolume",
        nextScene: "三林安居苑-8号楼-204室",
        effect: { set: { hasBottle: true, bottleWater: 0, _hongBottleLabel: true }, add: { itemCount: 1 } },
        elseScene: "整理整理"
      },
      {
        text: "放下瓶子",
  ...
  "三林安居苑-8号楼-204室-笔记本": {
    ...
    text: 
      "你翻开那本笔记本。封面是深蓝色的硬壳，边角已经磨得发白。\n\
前半本记的是些零碎的巡检记录和阀门编号——“3号碱液泵异响，已报修”“东区蒸汽管道保温层脱落”——后半本的内容变了。\n\
字迹从工整变得潦草：\n\
<em>“6/25 封存区被人剪开了。旧电解槽车间门开着。地上的水是灰色的，往老排水沟的方向渗。以后统一处理“——他妈的都十几年了。”</em>\n\
<em>“6/26 回上海了。”</em>\n\
<em>“6/27 把接的水放了一夜，好像没啥问题。”</em>\n\
<em>“6/28 上午 敲了对门小王的门。她是搞水质检测的。她把那瓶水拿去测了。”</em>\n\
后面还有一行，字迹有点模糊：\n<em>“我他妈早上喝了。Hg含量超标。”</em>",
    choices: [
      {
        text: "合上笔记本",
        nextScene: "三林安居苑-8号楼-204室"
    ...
    choices: [
      {
        ...
        condition: "itemCount < bagVolume",
        nextScene: "三林安居苑-8号楼-204室",
        effect: { set: { hasGasMask: true, maskRemainingUses: 1, _foundHongMask: true }, add: { itemCount: 1 } },
        elseScene: "整理整理"
      },
      {
        showCondition: "!hasGasMask",
...
你在床头柜的抽屉里找到了一部旧手机。充电插上试试——屏幕亮了起来。通话记录里最近的一个号码标注着“儿子 洪金宝”。你拨了过去——长嘟一声，然后忙音。\n\
你又试了一次。还是忙音。\n\
你翻到手机备忘录，看到一条没发出去的短信草稿：\n\
<em>“金宝，爸没事。你在张江那边自己小心。自来水别喝了。”</em>\n\
...
进去一看，一楼走道尽头有一户人家的门虚掩着，门缝里透出昏暗的光。楼梯间在右手边，铁扶手已经锈得发黑，墙上贴着褪色的楼层指示牌。";
  ...
  "三林安居苑-7号楼-1楼-某户": {
    image: "images/placeholder.png" /* TODO: images/安居苑/anJuYuanBuilding.png */,
    text: function(vars) {
      if(vars._visit["三林安居苑-7号楼-1楼-某户"] > 1) return "你来到这户人家的客厅，茶几上还放着半杯凉掉的茶，厨房传来断断续续的刮擦声。";
      return "你轻轻推开门。这是一户普通的人家——玄关摆着鞋柜，客厅的茶几上还放着半杯凉掉的茶。\n\
厨房方向传来刮擦声，指甲刮墙皮。你探头一看：一只老年丧尸正趴在厨房地上，不知道在啃什么。\n\
  ...
  "三林安居苑-7号楼-6楼": {
    ...
    text: function(vars) {
      ...
      if (vars._roofOpened) {
        ...
        desc += "楼梯尽头的天台门被一根生锈的铁链拴得死死的，链子上挂着一把同样锈迹斑斑的挂锁。你试着拽了拽，链子勒进门框，手掌生疼。\n";
...
底下是丧尸的拖步声，头顶是空旷的天。你闭了一会儿眼——这大概是爆发以来，难得安静的三分钟。" + restHint(vars);
  ...
  "三林安居苑-7号楼-5楼": {
    ...
    onEnter: { set: { currentPos: "居民楼" } },
    text: "五楼的走廊。地上铺着老式瓷砖，有几块已经裂成了蛛网状。并排三扇门：501、502、503，门牌号是那种老式的塑料字，502的“2”已经歪了。\n\
...
床上的被子叠得整整齐齐，枕头边放着一本《查理九世》。";
      if (vars._visit["三林安居苑-502-小卧室"] <= 1) {
        desc += "\n你蹲下身，往床底看了一眼。\n\
...
Object.assign(storyData,
  makeFlatDoor("201", "三林安居苑-7号楼-2楼", {
    ...
    empty: "屋里被翻得乱七八糟，抽屉全被拉出来倒扣在地上，滑轨还卡在半空。你里里外外看了一圈，连一粒米都没剩下。",
  ...
  makeFlatDoor("301", "三林安居苑-7号楼-3楼", {
    ...
    zombie: "馊味里混着一丝更腥的腐臭。你刚想细分辨，厨房的门帘猛地被撞开——一只丧尸顶着满身馊水扑了出来，指甲直取你的脸。"
  }),
