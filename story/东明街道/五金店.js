...
Object.assign(storyData, {
  ...
  "五金店": {
    ...
    text: function(vars) {
      if(vars._visit["五金店"] > 1) return "你又来到了五金店门口。卷帘门还是半开着，那道顶弯的凹痕还在，空气里的腥甜味也还在。" + describeWeather(vars);
      return "你来到三林路上那家老五金店。卷帘门半开着，只到膝盖高，边缘有一道被硬生生顶弯的凹痕——像是有东西从里面挤出去过。门缝里飘出一股机油混着腐臭的甜味，若有若无，可你知道那不是错觉。\n里面黑漆漆的看不清，静得反常——这种店不该这么安静。你注意到侧面的窗户破了一扇，后巷也能绕过去。" + describeWeather(vars);
     },
    choices: [
      {
        text: "从正门钻进去",
...
你身后传来嘎吱一声——卷帘门自己滑了下来，卡住了。你拉了两下，拉不动。\n退路断了。你只能往前。\n空气里有股化工品的味道，混着一丝若有若无的腥甜——整家店安静得不像话，像是你正站在什么东西的嘴里。",
  ...
  "五金店-正门-摸黑": {
    ...
    text: "你伸手探路，在黑暗中缓慢前进。脚下踢到了什么东西——哐当一声，油漆桶翻了。\n\
...
原来……它……一直……就……在那里……\n—— 结局：五金店毒气 ——"
  ...
  你小心地爬了进去，没有发出太大声音。你安全地落在了工具区的地面上。\n但一落地你就觉得不对劲——这里静得连穿堂风都没有，空气里沉着一股淡淡的化学甜味。窗下几只空纸箱叠得整整齐齐，进出都踩这一叠。",
    choices: [
      {
        text: "先看看墙上挂着什么工具",
        nextScene: "五金店-侧窗-探索"
...
你正打算再翻翻看有什么有用的，突然听到门外传来声音——嘎吱，嘎吱——有人在拖着步子走。就在门的那一侧。",
    choices: [
      {
        text: "推开工具区的门看看",
        nextScene: "结局-五金店-工具区"
...
左边那扇没锁的门缝里漏出的光忽明忽暗，门体微微发烫，贴着门板能听见“滋滋”的电流声——听久了头皮发麻，不像什么善茬。\n右边锁着的那扇门底下，拖着一道又深又黏的油渍，一直伸进门缝里。",
    choices: [
      {
...
—— 结局：配电房 ——"
  ...
  "五金店-后巷-偷看右门": {
    ...
    text: function(vars) {
      let segs = [];
      if(vars._lastScene == "五金店-后巷-偷看左门") segs.push("你转身走到右边那扇门，门确实打不开。");
      segs.push("你趴下身子，把眼睛凑到门缝处。\n一开始你什么都看不到——太暗了。然后你看到里面有什么东西在动，一个模糊的轮廓正在门后面缓缓移动。");
      segs.push("你调整了一下角度，想看清楚——然后你看到了一只眼睛。就在门缝的另一侧，也在看着你。");
      segs.push("你僵住了。它也僵住了。\n然后门被猛地拉开了。");
      return segs;
    },
    choices: [
      {
...
前方出现了一个岔路。右边的通道更宽一些，能隐约听到风声——好像通向外面。左边的楼梯不知道通向什么房间。",
  ...
  "结局-五金店-地铁": {
    ...
    text: [
      "你沿着右边的通道走了一段。通道越来越宽，墙上的管道越来越粗。空气变得潮湿而阴冷。",
