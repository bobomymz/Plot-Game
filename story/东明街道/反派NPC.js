// ========== 反派NPC.js ==========
// 东明街道 两个"活人反派"（非丧尸）：
//   B 三林路路霸 —— 用废车堵死"十字路口↔金谊"的三林路直达线（整条路带人行道），向落单幸存者讨要食物。
//     可给买路钱 / 正面搏斗（记忆闪色，武器分档难度）/ 有枪直接崩 / 掉头原路折返（按来向回出发地；
//     新达汇辅路只由 NPC 情报/金谊东侧入口引出，此处不剧透）。
...
// 路霸处理完成后的落地：按来向续行——_bullBack 非空(从金谊某场景来，返程方向)→回十字路口；
// 为空(从十字路口来，去金谊方向)→续走"前往金谊-2"。
...
Object.assign(storyData, {
  ...
  "三林路-路霸-堵路": {
    ...
    text: function(vars) {
      var desc = "三林路中段，几辆横七竖八撞在一起的废车把整条路拦了个严实——两辆轿车头尾相抵斜在路中央，旁边还别着一辆面包车，车缝里塞满了共享单车和倒伏的路障，连人行道那侧都被一辆骑上台阶的三轮车封死了。一个敦实的中年男人从废车后面站起来，短袖露出的两条手臂晒得黝黑，右手掂着一根拆下来的床腿钢管。他看见你，慢吞吞地把钢管往肩上一扛。\n“哎，兄弟。”他咧嘴一笑，露出一口被烟熏黄的牙，“此山是我开。这堆车是我一辆一辆挪过来的，缝儿全给你填死了——想过？留点买路钱。吃的就行，不图你那点破烂家当。”";
      if (vars._visit['三林路-路霸-堵路'] > 1) {
        desc += "\n路还是老样子——废车横在原地，那人也还守在那儿。";
        if (vars._roadBullBeatenDay > 0) desc += "看来上回那顿打，没让他长一点记性。";
      }
      return desc;
    },
    choices: function(vars) {
      ...
      cs.push({
        text: function(v) { return v._bullBack ? "不跟他纠缠，退回金谊广场" : "不跟他纠缠，折返回十字路口"; },
        nextScene: function(v) { return v._bullBack || "三林路-东明路 十字路口"; }, // _bullBack=来向场景ID：从金谊来退回金谊，否则回十字路口
        effect: updateTime(5)
      });
      return cs;
    }
  ...
  "三林路-路霸-买路": {
    ...
    text: "你从背包里摸出一份吃的，搁在最近那辆轿车的引擎盖上。他探过身来看了看，掂了掂，满意地揣进怀里，随后走到车堆中间，拖开一块挡在两车之间的铁皮——后面藏着一条刚够侧身的缝。\n“识相。走吧。”他咧咧嘴，“路上要是碰上好东西，回头给哥也捎一口——这条道，哥记你情。”\n你没答话，侧身从车缝里挤了过去。他这话说得轻巧，但眼神里那点盘算，你懂。",
    choices: [
  ...
  "三林路-路霸-打赢": {
    ...
    text: function(vars) {
      ...
      return "你抓住他收棍的空档，连消带打把他逼开。他踉跄着倒退几步，钢管“咣”地砸在地上，捂着腰扶住车头才没倒——显然吃疼了。他恶狠狠地瞪你一眼，撂下一句“……你等着，我有的是时间”，钻进废车堆，从路边的巷子里跑没影了。\n你喘着粗气，从两车之间那条缝里侧身挤过去——这条道今天是通了，但这梁子，八成明儿还得见。";
    },
    choices: [
